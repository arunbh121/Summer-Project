...
<head>
    ...
    <title>{{$title}}</title>
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="{{asset('fronted/assets/favicon.ico')}}assets/favicon.ico" />
    ...
    <link href="{{asset('fronted/css/styles.css')}}" rel="stylesheet" />
</head>
<body id="page-top">
<!-- Navigation-->
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="#page-top"><img src="{{asset('fronted/assets/logo.png')}}" height="100px" alt="..." /></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="#portfolio">Gallary</a></li>
...
<section class="page-section" id="services">
    <div class="container">
        ...
        <div class="row text-center">
            @foreach($data['row'] as $service)
            <div class="col-md-4">
                <h4 class="my-3">{{$service->name}}</h4>
{{--                <img  src="{{asset('uploads/'.$room->image)}}" height="162px" width="248px" class="zoom img-fluid "  alt="">--}}
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                    <a href="" class="fancybox" rel="ligthbox">
                        <img  src="{{asset('uploads/'.$room->feature_image)}}" height="162px" width="248px" class="zoom img-fluid "  alt="">
...
<section class="page-section" id="about">
    <div class="container">
        <div class="text-center">
            ...
            <h3 class="section-subheading text-muted">Healthy Food, Good Living, </h3>
        </div>
        <ul class="timeline">
            <li>
